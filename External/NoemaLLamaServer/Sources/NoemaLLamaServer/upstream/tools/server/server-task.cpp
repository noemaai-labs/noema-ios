...
json result_timings::to_json() const {
    ...
    if (!speculative_type.empty()) {
        base["speculative_type"] = speculative_type;
        base["speculative_state"] = speculative_state;
        base["draft_attempts"] = draft_attempts;
        base["draft_empty_attempts"] = draft_empty_attempts;
        base["draft_n"] = draft_n;
        base["draft_n_accepted"] = draft_n_accepted;
        base["draft_ms"] = draft_ms;
        base["draft_verification_ms"] = draft_verification_ms;
        base["draft_rollback_ms"] = draft_rollback_ms;
        base["draft_accepted_per_position"] = draft_accepted_per_position;
        if (draft_n_budget >= 0) {
            base["draft_n_budget"] = draft_n_budget;
        }
        if (draft_n_dyn >= 0) {
            base["draft_n_dyn"] = draft_n_dyn;
        }
    }
